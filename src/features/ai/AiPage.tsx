...
export function AiPage() {
  ...
  return <section className="ai-page">
    <div className="page-toolbar"><Button variant="ghost" onClick={() => editMcp()}><Plug size={14} />MCP 工具</Button><Button variant="primary" onClick={() => editProvider()}><Plus size={14} />添加供应商</Button></div>
